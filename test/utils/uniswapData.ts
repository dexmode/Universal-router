...
import { MixedRouteTrade, MixedRouteSDK, Trade as RouterTrade } from 'dmode-router-sdk'
import { Trade as V2Trade, Pair, Route as RouteV2, computePairAddress } from 'dmode-v2-sdk'
import {
  Trade as V3Trade,
  Pool,
  Route as RouteV3,
...
import { CurrencyAmount, TradeType, Ether, Token, Percent, Currency } from 'dmode-sdk-core'
